<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/ProfileMaster.Master"
    Inherits="System.Web.Mvc.ViewPage<IEnumerable<DhotGroupNew.Models.tb_ImagesDhot>>" %>
        ...
        <div class="main_frame_right_box">
            ...
            <table class="border" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <a href="<%= Url.Action("Edit", "images1", new { id=item.ImageID })%>">
                            <img src="<%=Url.Content("~/SiteImages/edit.png") %>" border="0" alt="edit" /></a>
                    </td>
                    <td>
                        <a href="<%= Url.Action("Delete", "images1", new { id=item.ImageID })%>">
